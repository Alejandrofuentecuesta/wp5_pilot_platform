            ...
            <div className="rounded-xl border border-admin-border bg-admin-surface-alt p-4 space-y-2">
              ...
              <div className="mt-2">
                ...
                <ol className="list-decimal list-inside space-y-1 text-admin-muted text-xs">
                  ...
                  <li>When a participant joins, the backend reads their pre-chat topic survey (Column I / Column II) and selects the agents that best satisfy the treatment quotas.</li>
